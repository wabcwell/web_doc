        ...
        <div class="container-fluid">
            ...
            <div class="row g-3 mb-4">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="card stat-card documents border-0 shadow-sm">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div class="stat-icon bg-white bg-opacity-70 text-muted rounded-circle d-flex align-items-center justify-content-center">
                                        <i class="bi bi-file-earmark-text fs-4"></i>
                                    </div>
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="card-title mb-1 text-secondary fw-normal">总文档数</h6>
                                    <h3 class="mb-0 fw-bold"><?php echo $totalDocuments; ?></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="card stat-card users border-0 shadow-sm">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div class="stat-icon bg-white bg-opacity-70 text-muted rounded-circle d-flex align-items-center justify-content-center">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="card stat-card created border-0 shadow-sm">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div class="stat-icon bg-white bg-opacity-70 text-muted rounded-circle d-flex align-items-center justify-content-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <h3 class="mb-0 fw-bold"><?php echo $recentCreatedCount; ?></h3>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="card stat-card deleted border-0 shadow-sm">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div class="stat-icon bg-white bg-opacity-70 text-muted rounded-circle d-flex align-items-center justify-content-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <h3 class="mb-0 fw-bold"><?php echo $recentDeletedCount; ?></h3>
                                    <small class="text-muted fs-7">最近14天</small>
                                </div>
                            </div>
                        </div>
